...
import static mx.com.bankaya.shared.kipe.domain.RolesAccessesFixture.*;
...
@UnitTest
class ChallengeAuthorizationsTest {

  private static final ChallengeAuthorizations authorizations = new ChallengeAuthorizations(
