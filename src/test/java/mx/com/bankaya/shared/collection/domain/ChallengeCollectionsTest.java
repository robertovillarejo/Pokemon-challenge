package mx.com.bankaya.shared.collection.domain;
...
@UnitTest
class ChallengeCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class ChallengeCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = ChallengeCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = ChallengeCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class ChallengeCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = ChallengeCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = ChallengeCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class ChallengeCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = ChallengeCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = ChallengeCollections.immutable(input);
  ...
  class ChallengeMapTest {
    ...
    void shouldGetEmptyImmutableMapFromNullMap() {
      ...
      Map<Object, Object> map = ChallengeCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = ChallengeCollections.immutable(input);
