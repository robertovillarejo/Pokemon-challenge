...
import mx.com.bankaya.shared.authentication.application.AuthenticatedUser;
import mx.com.bankaya.shared.authentication.domain.Role;
import mx.com.bankaya.shared.authentication.domain.Roles;
import mx.com.bankaya.shared.authentication.domain.Username;
import mx.com.bankaya.shared.kipe.domain.Action;
import mx.com.bankaya.shared.kipe.domain.Resource;
import mx.com.bankaya.shared.kipe.domain.RolesAccesses;

@Component
public class ChallengeAuthorizations {

  private final RolesAccesses accesses;

  public ChallengeAuthorizations(Collection<RolesAccesses> accesses) {
